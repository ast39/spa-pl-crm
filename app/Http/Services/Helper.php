...
class Helper {
    ...
    public static function programStatus(int $status): string
    {
        switch ($status) {
            ...
            case 1  : return __('Доступна');

            default : return __('Закрыта');
        }
    }
    ...
    public static function seanceStatus(int $status): string
    {
        switch ($status) {
            ...
            case 2  : return __('отменена');

            default : return __('состоялась');
        }
    }
    ...
    public static function itemStatus(int $status): string
    {
        switch ($status) {
            ...
            case 1  : return __('В наличии');

            default : return __('Закончился');
        }
    }
    ...
    public static function programType(int $type): string
    {
        switch ($type) {
            ...
            case ProgramType::Man->value   : return __('Для мужчин');
            case ProgramType::Woman->value : return __('Для женщин');
            case ProgramType::Pair->value  : return __('Для пар');

            default : return __('Для всех');
        }
    }
    ...
    public static function payType(int $type): string
    {
        switch ($type) {
            ...
            case PayType::Cash->value  : return __('наличкой');
            case PayType::Card->value  : return __('картой');
            case PayType::Phone->value : return __('переводом');
